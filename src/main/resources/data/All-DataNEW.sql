...
VALUES ('Починить кран', 'Требуется починить кран на кухне', 50.00, 'OPEN', true, 1, 1, 19, 1, null,
       ...
       ('Покрасить комнату', 'Нужно покрасить стены в гостиной', 200.00, 'IN_PROGRESS', true, 2, 2, 8, 2, 4,
        '2024-05-14 12:00:00', '2024-05-14 12:00:00'),
       ...
       ('Офисный переезд', 'Требуется упаковать мебель и вещи', 500.00, 'OPEN', true, 4, 4,
        28, 4, 2, '2024-05-14 12:00:00', '2024-05-14 12:00:00'),
       ('Установить светильники', 'Хочу установить старые светильники в сарае', 100.00, 'CANCELED', true, 5, 4, 18, 4,
...
VALUES (1, 'Отличная работа!', 5, 4, '2024-05-14 12:00:00'),
       ...
       (3, 'Отличный заказчик!', 2, 3, '2024-05-14 12:30:00'),
       (2, 'Требуется улучшение', 1, 1, '2024-05-14 13:00:00');
