...
VALUES ('Джон', 'Доу', 'john.doe@example.com', true, 'password123',
        '2024-04-29 10:00:00', '2024-04-29 10:00:00', false, 5),
       ('Джейн', 'Смит', 'jane.smith@example.com', true, 'qwerty123',
        '2024-04-29 11:00:00', '2024-04-29 11:00:00', false, 6),
       ('Алиса', 'Джонсон', 'alice.johnson@example.com', true, 'test123',
        '2024-04-29 12:00:00', '2024-04-29 12:00:00', false, 7),
       ('Боб', 'Уильямс', 'bob.williams@example.com', true, 'password456',
        '2024-04-29 13:00:00', '2024-04-29 13:00:00', false, 8),
       ('Ева', 'Браун', 'eva.brown@example.com', true, 'abc123',
        '2024-04-29 14:00:00', '2024-04-29 14:00:00', false, 9),
       ('Иван', 'Иванов', 'ivan.ivanov@example.com', true, 'ivan123',
        '2024-05-01 10:00:00', '2024-05-01 10:00:00', false, 10),
       ('Мария', 'Петрова', 'maria.petrova@example.com', true, 'maria456',
        '2024-05-01 11:00:00', '2024-05-01 11:00:00', false, 11),
       ('Александр', 'Сидоров', 'alex.sid@example.com', true, 'sid123',
        '2024-05-01 12:00:00', '2024-05-01 12:00:00', false, 12),
       ('Ольга', 'Смирнова', 'olga.sm@example.com', true, 'olga789',
        '2024-05-01 13:00:00', '2024-05-01 13:00:00', false, 13),
       ('Петр', 'Кузнецов', 'peter.kuz@example.com', true, 'peter456',
        '2024-05-01 14:00:00', '2024-05-01 14:00:00', false, 14),
       ('Светлана', 'Иванова', 'svetlana.ivanova@example.com', true, 'sveta123',
        '2024-05-01 15:00:00', '2024-05-01 15:00:00', false, 15);
...
VALUES ('Починить кран', 'Требуется починить кран на кухне', 50.00, 'OPEN', true, 1, 1, 19, 5, null,
        '2024-05-14 12:00:00', '2024-05-14 12:00:00'),
       ('Покрасить комнату', 'Нужно покрасить стены в гостиной', 200.00, 'IN_PROGRESS', true, 2, 2, 8, 4, 4,
        '2024-05-14 12:00:00', '2024-05-14 12:00:00'),
       ('Установить светильники', 'Требуется установить новые светильники в коридоре', 100.00, 'COMPLETED', true, 3, 3,
        2, 3, 5, '2024-05-14 12:00:00', '2024-05-14 12:00:00'),
       ('Офисный переезд', 'Требуется упаковать мебель и вещи', 500.00, 'OPEN', true, 4, 4,
        28, 2, 3, '2024-05-14 12:00:00', '2024-05-14 12:00:00'),
       ('Установить светильники', 'Хочу установить старые светильники в сарае', 100.00, 'CANCELED', true, 5, 4, 18, 1,
        1, '2024-05-14 12:00:00', '2024-05-14 12:00:00');

-- Feedback
INSERT INTO feedback (sender_id, text, grade, task_id, created_on)
VALUES (1, 'Отличная работа!', 5, 4, '2024-05-14 12:00:00'),
       (3, 'Очень впечатляющая работа!', 4, 5, '2024-05-14 12:15:00'),
       (1, NULL, 3, 2, '2024-05-14 12:30:00'),
       (5, 'Отличный заказчик!', 2, 3, '2024-05-14 12:30:00'),
       (2, 'Отличный заказчик!', 2, 3, '2024-05-14 12:30:00'),
       (2, 'Требуется улучшение', 1, 2, '2024-05-14 13:00:00');
