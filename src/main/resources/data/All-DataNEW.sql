...
VALUES ('Джон', 'Доу', 'john.doe@example.com', true, 'password123',
       ...
       ('Александр', 'Сидоров', 'alex.sid@example.com', true, 'sid123',
        '2024-05-01 12:00:00', '2024-05-01 12:00:00', false, 12, 90.0),
...
VALUES ('Починить кран', 'Требуется починить кран на кухне', 50.00, 'OPEN', true, 1, 1, 19, 5, null,
       ...
       ('Установить светильники', 'Хочу установить старые светильники в сарае', 100.00, 'CANCELED', true, 5, 4, 18, 1,
        2, '2024-05-14 12:00:00', '2024-05-14 12:00:00'),
       ('Установить люстру', 'Хочу установить новую люстру в туалете', 100.00, 'COMPLETED', true, 5, 4, 18, 1,
        3, '2024-05-14 12:00:00', '2024-05-14 12:00:00'),
       ('Разбить люстру', 'Хочу разбить новую люстру в туалете', 100.00, 'COMPLETED', true, 5, 4, 18, 1,
        3, '2024-05-14 12:00:00', '2024-05-14 12:00:00');

-- Feedback
INSERT INTO feedback (sender_id, text, grade, task_id, created_on)
VALUES (3, 'Хреновый заказчик! Не угостил чаем', 3, 4, '2024-05-14 12:00:00'),
       (3, 'Заказчица бомба!', 4, 5, '2024-05-14 12:15:00'),
       (4, NULL, 3, 2, '2024-05-14 12:30:00'),
       (5, 'Отличный заказчик!', 5, 3, '2024-05-14 12:30:00'),
       (2, 'Требуется улучшение', 1, 2, '2024-05-14 13:00:00'),
       (2, 'Отличный заказчик!', 5, 4, '2024-05-14 12:30:00'),
       (1, 'Отличный заказчик!', 2, 6, '2024-05-14 12:30:00'),
       (1, 'Отличный заказчик!', 5, 7, '2024-05-14 12:30:00');
