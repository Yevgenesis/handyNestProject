...
public class Category {
  ...
  @Builder.Default
  @Column(name = "requires_onsite_coordination", nullable = false)
  @Schema(description = "Whether this service needs direct onsite coordination", example = "true")
  private boolean requiresOnsiteCoordination = false;

  @Builder.Default
  @Enumerated(EnumType.STRING)
  @Column(name = "contact_reveal_stage", nullable = false, length = 32)
  @Schema(description = "Earliest stage when participant contact reveal is allowed")
  private ContactRevealStage contactRevealStage = ContactRevealStage.NEVER;
