...
public class NoopFileStorageService implements FileStorageService {
  ...
  public StoredObjectMetadata inspectObject(MarketplaceAttachment attachment) {
    return new StoredObjectMetadata(true, attachment.getSizeBytes(), attachment.getContentType());
  }

  @Override
  public void deleteObject(MarketplaceAttachment attachment) {
    // Intentionally empty for tests and local runs with storage disabled.
  }
}
