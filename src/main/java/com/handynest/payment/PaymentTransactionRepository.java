...
public interface PaymentTransactionRepository extends JpaRepository<PaymentTransaction, Long> {
  ...
  @EntityGraph(attributePaths = {"deal", "task", "customer", "performer", "performer.user"})
  Optional<PaymentTransaction> findByIdempotencyKeyAndCustomerId(
      String idempotencyKey, Long customerId);
  ...
  Optional<PaymentTransaction> findByProviderPaymentIdForUpdate(
      @Param("provider") String provider, @Param("pspPaymentId") String pspPaymentId);
}
