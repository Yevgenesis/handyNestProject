...
@Tag(name = "Geo", description = "Public Kazakhstan geo directory")
public class GeoApiV1Controller {
    ...
    public List<GeoRegionResponse> findRegions(
        ...
        return geoQueryService.findRegions(countryCode, SupportedLocaleResolver.resolve(locale, acceptLanguage));
    }
    ...
    public List<GeoCityResponse> findCities(
        ...
        return geoQueryService.findCities(regionId, SupportedLocaleResolver.resolve(locale, acceptLanguage));
    }
    ...
    public List<GeoDistrictResponse> findDistricts(
        ...
        return geoQueryService.findDistricts(cityId, SupportedLocaleResolver.resolve(locale, acceptLanguage));
    }
}
