...
public class UserProfileService {
    ...
    public UserProfileResponse me(UserDetails userDetails) {
        ...
        CustomerProfile customerProfile = customerProfileRepository.findByUserId(user.getId())
                .orElseThrow(() -> new ResourceNotFoundException("CustomerProfile", user.getPublicId()));
        BusinessProfile businessProfile = businessProfileRepository.findByUserId(user.getId()).orElse(null);
    ...
    private UserProfileResponse toResponse(
        ...
        return new UserProfileResponse(
                ...
                businessProfile == null ? null : new BusinessProfileResponse(
