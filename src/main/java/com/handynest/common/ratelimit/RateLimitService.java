...
public class RateLimitService {
    ...
    public void cleanupIdleBuckets() {
        ...
        buckets.entrySet().removeIf(entry -> entry.getValue().getLastSeenAt().isBefore(oldestAllowedAccess));
    }
    ...
    private void consume(String key, RateLimitProperties.Limit limit) {
        ...
        BucketEntry bucketEntry = buckets.computeIfAbsent(key, ignored -> new BucketEntry(newBucket(limit)));
