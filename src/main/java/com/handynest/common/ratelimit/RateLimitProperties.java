...
public class RateLimitProperties {
  ...
  private Limit otpRequest = new Limit(3, Duration.ofMinutes(10));
  private Limit otpVerify = new Limit(5, Duration.ofMinutes(10));
  private Limit emailVerificationRequest = new Limit(3, Duration.ofHours(1));
  ...
  public Limit getOtpRequest() {
    return otpRequest;
  }

  public void setOtpRequest(Limit otpRequest) {
    this.otpRequest = otpRequest;
  }

  public Limit getOtpVerify() {
    return otpVerify;
  }

  public void setOtpVerify(Limit otpVerify) {
    this.otpVerify = otpVerify;
  }

  public Limit getEmailVerificationRequest() {
    return emailVerificationRequest;
  }

  public void setEmailVerificationRequest(Limit emailVerificationRequest) {
