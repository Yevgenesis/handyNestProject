...
class ApiExceptionHandlerTest {
    ...
    void handleBusinessExceptionReturnsUnifiedErrorContract() {
        ...
        MockHttpServletRequest request = new MockHttpServletRequest("GET", "/api/v1/tasks/01JZ7Y6F4C6XKQ3M6YB4F9M1AA");

        ResponseEntity<ApiErrorResponse> response = handler.handleBusinessException(
                new ResourceNotFoundException("Task", "01JZ7Y6F4C6XKQ3M6YB4F9M1AA"),
                request
        );
